package ru.ibragimov.pagetopage_ibragimov.util;
...
import ru.ibragimov.pagetopage_ibragimov.HelloApplication;
...
public class Manager {
    ...
    public static void showMainStage(Stage stage, String fxmlFileName, String title) {
        FXMLLoader fxmlLoader = new FXMLLoader(HelloApplication.class.getResource(String.valueOf(fxmlFileName)));
        try {
